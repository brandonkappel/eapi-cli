...
namespace YP.SassyMQ.Lib.RabbitMQ
{
    public partial class SMQEffortlessProxyDataCoordinator : SMQActorBase
    {
        ...
        {
            return this.SendMessage("crudcoordinator.crud.effortlessproxydatacoordinator.addportfolioitemretired", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.effortlessproxydatacoordinator.getportfolioitemsretired", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.effortlessproxydatacoordinator.updateportfolioitemretired", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.effortlessproxydatacoordinator.deleteportfolioitemretired", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.effortlessproxydatacoordinator.addportfolioretired", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.effortlessproxydatacoordinator.getportfoliosretired", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.effortlessproxydatacoordinator.updateportfolioretired", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.effortlessproxydatacoordinator.deleteportfolioretired", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.effortlessproxydatacoordinator.addcustomertype", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.effortlessproxydatacoordinator.getcustomertypes", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.effortlessproxydatacoordinator.updatecustomertype", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.effortlessproxydatacoordinator.deletecustomertype", payload, replyHandler, timeoutHandler, waitTimeout);
        }
