    ...
    public static class RoleHandlerFactory
    {
        public static RoleHandlerBase CreateHandler(string runas, string amqps)
        {
            ...
            switch (runas.ToLower())
            {
                ...
                case "developer":
                    return new DeveloperCLIHandler(amqps, accessToken);

                    
                case "effortlessproxydatacoordinator":
                    return new EffortlessProxyDataCoordinatorCLIHandler(amqps, accessToken);
        ...
        public static void ListRoles(StringBuilder sbHelpBuilder)
        {
            ...
            sbHelpBuilder.AppendLine(" - Developer");
            sbHelpBuilder.AppendLine(" - EffortlessProxyDataCoordinator");
